...
TxtType.prototype.tick = function() {
 ...
 var i = this.loopNum % this.toRotate
  .length;
 ...
 if (this.isDeleting) {
  ...
  this.txt = fullTxt.substring(0, this
   .txt.length - 1);
...
window.onload = function() {
 ...
 for (var i = 0; i < elements
  ...
  var period = elements[i].getAttribute(
   'data-period');

  if (toRotate) {

   new TxtType(elements[i], JSON.parse(
    toRotate), period);
